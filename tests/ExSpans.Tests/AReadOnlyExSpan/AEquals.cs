...
namespace Zyl.ExSpans.Tests.AReadOnlyExSpan {
    public static partial class AEquals {
        [Fact]
        public static void ZeroLengthEquals_StringComparison() {
            ...
            span = new ReadOnlyExSpan<char>(a, 1, 0);
        ...
        public static void LengthMismatchEquals_StringComparison() {
            char[] a = { '4', '5', '6' };
            var span = new ReadOnlyExSpan<char>(a, 0, 2);
        ...
        public static void EqualsOverlappingMatch_StringComparison() {
            char[] a = { '4', '5', '6', '5', '6', '5' };
            var span = new ReadOnlyExSpan<char>(a, 1, 3);
            var slice = new ReadOnlyExSpan<char>(a, 3, 3);
            Assert.True(span.Equals(slice, StringComparison.Ordinal));
        ...
        public static void EqualsMatchDifferentSpans_StringComparison() {
            char[] a = { '4', '5', '6', '7' };
            char[] b = { '4', '5', '6' };
            var span = new ReadOnlyExSpan<char>(a, 0, 3);
        ...
        public static void EqualsNoMatch_StringComparison() {
            for (int length = 1; length < 150; length++) {
                for (int mismatchIndex = 0; mismatchIndex < length; mismatchIndex++) {
                    ...
                    var firstSpan = new ReadOnlyExSpan<char>(first);
                    var secondSpan = new ReadOnlyExSpan<char>(second);
