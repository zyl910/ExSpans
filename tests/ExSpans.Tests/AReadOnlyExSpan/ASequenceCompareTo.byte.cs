...
namespace Zyl.ExSpans.Tests.AReadOnlyExSpan {
    public static partial class ASequenceCompareTo {
        ...
        public static void ZeroLengthSequenceCompareTo_Byte() {
            ...
            var first = new ReadOnlyExSpan<byte>(a, 1, 0);
            var second = new ReadOnlyExSpan<byte>(a, 2, 0);
        ...
        public static void SequenceCompareToArrayImplicit_Byte() {
            byte[] a = { 4, 5, 6 };
            var first = new ReadOnlyExSpan<byte>(a, 0, 3);
        ...
        public static void SequenceCompareToArraySegmentImplicit_Byte() {
            ...
            var first = new ReadOnlyExSpan<byte>(src, 0, 3);
        ...
        public static void LengthMismatchSequenceCompareTo_Byte() {
            byte[] a = { 4, 5, 6 };
            var first = new ReadOnlyExSpan<byte>(a, 0, 2);
            var second = new ReadOnlyExSpan<byte>(a, 0, 3);
            int result = first.SequenceCompareTo<byte>(second);
            ...
            first = new ReadOnlyExSpan<byte>(a, 1, 0);
        ...
        public static void SequenceCompareToEqual_Byte() {
            for (int length = 1; length < 128; length++) {
                ...
                var firstSpan = new ReadOnlyExSpan<byte>(first);
                var secondSpan = new ReadOnlyExSpan<byte>(second);
        ...
        public static void MakeSureNoSequenceCompareToChecksGoOutOfRange_Byte() {
            for (int length = 0; length < 100; length++) {
                ...
                var span1 = new ReadOnlyExSpan<byte>(first, 1, length);
                var span2 = new ReadOnlyExSpan<byte>(second, 1, length);
