    ...
    public static partial class ASplit {
        ...
        public static void Split_SingleElementSeparator() {
            ...
            static void Test<T>(T[] value, T separator, Range[] result) where T : IEquatable<T> =>
                AssertEnsureCorrectEnumeration(new ReadOnlyExSpan<T>(value).Split(separator), result);
        }
        ...
        public static void SplitAnySeparatorData() {
            ...
            static void Test<T>(T[] value, T[] separator, Range[] result) where T : IEquatable<T> {
                AssertEnsureCorrectEnumeration(new ReadOnlyExSpan<T>(value).SplitAny(separator), result);
                ...
                {
                    var charEnumerator = new ReadOnlyExSpan<char>(source).SplitAny(SearchValues.Create(separators));
