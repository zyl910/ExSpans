...
namespace Zyl.ExSpans.Tests.AReadOnlyExSpan {
    public static partial class ALastIndexOfAny {
        ...
        public static void LastIndexOfAnyStrings_Byte(string raw, string search, char expectResult, int expectIndex) {
            ...
            var span = new ReadOnlyExSpan<byte>(buffers);
            ...
            if (searchFor.Length == 1) {
                ...
                index = span.LastIndexOfAny(new ReadOnlyExSpan<byte>(searchForBytes));
            }
        ...
        public static void ZeroLengthLastIndexOfAny_Byte_TwoByte() {
            ...
            TSize idx = sp.LastIndexOfAny<byte>(0, 0);
            Assert.Equal(-1, idx);
        }
        ...
        public static void TestMultipleMatchLastIndexOfAny_Byte_TwoByte() {
            for (int length = 3; length < byte.MaxValue; length++) {
                ...
                ReadOnlyExSpan<byte> span = new ReadOnlyExSpan<byte>(a);
                TSize idx = span.LastIndexOfAny<byte>(200, 200);
        ...
        public static void MakeSureNoChecksGoOutOfRangeLastIndexOfAny_Byte_TwoByte() {
            for (int length = 1; length < byte.MaxValue; length++) {
                ...
                TSize index = span.LastIndexOfAny<byte>(99, 98);
            ...
            for (int length = 1; length < byte.MaxValue; length++) {
                ...
                a[length + 1] = 99;
                ReadOnlyExSpan<byte> span = new ReadOnlyExSpan<byte>(a, 1, length - 1);
                TSize index = span.LastIndexOfAny<byte>(99, 99);
                Assert.Equal(-1, index);
            }
        }
        ...
        public static void ZeroLengthIndexOf_Byte_ThreeByte() {
            ReadOnlyExSpan<byte> sp = new ReadOnlyExSpan<byte>(ArrayHelper.Empty<byte>());
            TSize idx = sp.LastIndexOfAny<byte>(0, 0, 0);
            Assert.Equal(-1, idx);
        }
        ...
        public static void TestMultipleMatchLastIndexOfAny_Byte_ThreeByte() {
            for (int length = 4; length < byte.MaxValue; length++) {
                ...
                ReadOnlyExSpan<byte> span = new ReadOnlyExSpan<byte>(a);
                TSize idx = span.LastIndexOfAny<byte>(200, 200, 200);
                Assert.Equal(length - 1, idx);
            }
        }
        ...
        public static void MakeSureNoChecksGoOutOfRangeLastIndexOfAny_Byte_ThreeByte() {
            for (int length = 1; length < byte.MaxValue; length++) {
                ...
                a[length + 1] = 98;
                ReadOnlyExSpan<byte> span = new ReadOnlyExSpan<byte>(a, 1, length - 1);
                TSize index = span.LastIndexOfAny<byte>(99, 98, 99);
                Assert.Equal(-1, index);
            }
            ...
            for (int length = 1; length < byte.MaxValue; length++) {
                ...
                a[length + 1] = 99;
                ReadOnlyExSpan<byte> span = new ReadOnlyExSpan<byte>(a, 1, length - 1);
                TSize index = span.LastIndexOfAny<byte>(99, 99, 99);
                Assert.Equal(-1, index);
            }
        }
