...
namespace Zyl.SizableSpans.Tests.AReadOnlySizableSpan {
    public static class ACopyTo {
        ...
        public static void TryCopyTo() {
            ...
            ReadOnlySizableSpan<int> srcSpan = new ReadOnlySizableSpan<int>(src);
        ...
        */
        ...
        public static void Overlapping1() {
            ...
            ReadOnlySizableSpan<int> src = new ReadOnlySizableSpan<int>(a, (TSize)1, (TSize)6);
        ...
        public static void Overlapping2() {
            ...
            ReadOnlySizableSpan<int> src = new ReadOnlySizableSpan<int>(a, (TSize)2, (TSize)6);
        ...
        public static void CopyToVaryingSizes() {
            ...
            ReadOnlySizableSpan<byte> inputSizableSpan = inputArray;
