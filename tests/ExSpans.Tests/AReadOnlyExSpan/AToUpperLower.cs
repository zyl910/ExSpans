...
namespace Zyl.ExSpans.Tests.AReadOnlyExSpan {
    public partial class AToUpperLower {
        public static IEnumerable<object[]> MemoryExtensionsToUpperLowerOverlapping() {
            ...
            yield return new TestHelpers.AssertThrowsAction<char>[] { (Span<char> buffer) => ((ReadOnlyExSpan<char>)buffer).ToLower(buffer, null) };
            yield return new TestHelpers.AssertThrowsAction<char>[] { (Span<char> buffer) => ((ReadOnlyExSpan<char>)buffer).ToLower(buffer.Slice(1, 1), null) };
            yield return new TestHelpers.AssertThrowsAction<char>[] { (Span<char> buffer) => ((ReadOnlyExSpan<char>)buffer).ToLower(buffer.Slice(0, 1), null) };
            yield return new TestHelpers.AssertThrowsAction<char>[] { (Span<char> buffer) => ((ReadOnlyExSpan<char>)buffer).ToLower(buffer.Slice(2, 1), null) };
            ...
            yield return new TestHelpers.AssertThrowsAction<char>[] { (Span<char> buffer) => ((ReadOnlyExSpan<char>)buffer).ToLowerInvariant(buffer) };
            yield return new TestHelpers.AssertThrowsAction<char>[] { (Span<char> buffer) => ((ReadOnlyExSpan<char>)buffer).ToLowerInvariant(buffer.Slice(1, 1)) };
            yield return new TestHelpers.AssertThrowsAction<char>[] { (Span<char> buffer) => ((ReadOnlyExSpan<char>)buffer).ToLowerInvariant(buffer.Slice(0, 1)) };
            yield return new TestHelpers.AssertThrowsAction<char>[] { (Span<char> buffer) => ((ReadOnlyExSpan<char>)buffer).ToLowerInvariant(buffer.Slice(2, 1)) };
            ...
            yield return new TestHelpers.AssertThrowsAction<char>[] { (Span<char> buffer) => ((ReadOnlyExSpan<char>)buffer).ToUpper(buffer, null) };
            yield return new TestHelpers.AssertThrowsAction<char>[] { (Span<char> buffer) => ((ReadOnlyExSpan<char>)buffer).ToUpper(buffer.Slice(1, 1), null) };
            yield return new TestHelpers.AssertThrowsAction<char>[] { (Span<char> buffer) => ((ReadOnlyExSpan<char>)buffer).ToUpper(buffer.Slice(0, 1), null) };
            yield return new TestHelpers.AssertThrowsAction<char>[] { (Span<char> buffer) => ((ReadOnlyExSpan<char>)buffer).ToUpper(buffer.Slice(2, 1), null) };
            ...
            yield return new TestHelpers.AssertThrowsAction<char>[] { (Span<char> buffer) => ((ReadOnlyExSpan<char>)buffer).ToUpperInvariant(buffer) };
            yield return new TestHelpers.AssertThrowsAction<char>[] { (Span<char> buffer) => ((ReadOnlyExSpan<char>)buffer).ToUpperInvariant(buffer.Slice(1, 1)) };
            yield return new TestHelpers.AssertThrowsAction<char>[] { (Span<char> buffer) => ((ReadOnlyExSpan<char>)buffer).ToUpperInvariant(buffer.Slice(0, 1)) };
            yield return new TestHelpers.AssertThrowsAction<char>[] { (Span<char> buffer) => ((ReadOnlyExSpan<char>)buffer).ToUpperInvariant(buffer.Slice(2, 1)) };
