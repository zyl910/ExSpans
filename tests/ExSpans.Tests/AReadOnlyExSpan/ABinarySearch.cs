...
namespace Zyl.ExSpans.Tests.AReadOnlyExSpan {
    public static partial class ABinarySearch {
        ...
        public static void BinarySearch_Slice() {
            ...
            var span = new ReadOnlyExSpan<int>(array, 1, array.Length - 2);
        ...
        private static void TestOverloads<T, TComparable>(
            ...
            TestReadOnlyExSpan(array, value, expectedIndex);
            TestIComparableSpan(array, value, expectedIndex);
            TestIComparableReadOnlyExSpan(array, value, expectedIndex);
            TestComparerSpan(array, value, expectedIndex);
            TestComparerReadOnlyExSpan(array, value, expectedIndex);
        }
        ...
        private static void TestReadOnlyExSpan<T, TComparable>(
            T[] array, TComparable value, int expectedIndex)
            where TComparable : IComparable<T> {
            var span = new ReadOnlyExSpan<T>(array);
            var index = span.BinarySearch(value);
            Assert.Equal(expectedIndex, index);
        }
        ...
        private static void TestIComparableReadOnlyExSpan<T, TComparable>(
            T[] array, TComparable value, int expectedIndex)
            where TComparable : IComparable<T>, T {
            var span = new ReadOnlyExSpan<T>(array);
            var index = span.BinarySearch((IComparable<T>)value);
        ...
        private static void TestComparerReadOnlyExSpan<T, TComparable>(
            T[] array, TComparable value, int expectedIndex)
            where TComparable : IComparable<T>, T {
            var span = new ReadOnlyExSpan<T>(array);
            var index = span.BinarySearch(value, Comparer<T>.Default);
