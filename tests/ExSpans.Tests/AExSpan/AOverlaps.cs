...
namespace Zyl.ExSpans.Tests.AExSpan {
    public static partial class AOverlaps {
        private static void DoubleEachElementForwards(ExSpan<int> source, ExSpan<int> destination) {
        ...
        public static void TestAlignedForwards() {
            for (int i = 0; i < 14; i++) {
                ...
                ExSpan<int> source = a.AsExSpan(7, 5);
        ...
        private static void DoubleEachElementBackwards(ExSpan<int> source, ExSpan<int> destination) {
            if (source.Length != destination.Length)
                throw new ArgumentException();
        ...
        public static void SizeOf1Overlaps() {
            ...
            Assert.True(a.AsExSpan(0, 12).Overlaps(a.AsExSpan(8, 8), out int elementOffset));
