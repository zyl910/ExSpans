...
namespace Zyl.SizableSpans {
    ...
    public static partial class SizableMemoryMarshal {
        ...
        /// Thrown if the Length property of the new SizableSpan would exceed int.MaxValue.
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe SizableSpan<byte> AsBytes<T>(SizableSpan<T> span)
            where T : struct {
            if (RuntimeHelpers.IsReferenceOrContainsReferences<T>())
                ThrowHelper.ThrowInvalidTypeWithPointersNotSupported(typeof(T));

            return new SizableSpan<byte>(
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe ReadOnlySizableSpan<byte> AsBytes<T>(ReadOnlySizableSpan<T> span)
            where T : struct {
            if (RuntimeHelpers.IsReferenceOrContainsReferences<T>())
                ThrowHelper.ThrowInvalidTypeWithPointersNotSupported(typeof(T));

            return new ReadOnlySizableSpan<byte>(
                ref Unsafe.As<T, byte>(ref GetReference(span)),
                checked(span.Length * sizeof(T)));
        }
        ...
        /// </summary>
        public static ref T GetReference<T>(SizableSpan<T> span) => ref span._reference;
        ...
        /// would have been stored. Such a reference may or may not be null. It can be used for pinning but must never be dereferenced.
        /// </summary>
        public static ref T GetReference<T>(ReadOnlySizableSpan<T> span) => ref span._reference;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static unsafe ref T GetNonNullPinnableReference<T>(SizableSpan<T> span) => ref (span.Length != 0) ? ref Unsafe.AsRef(in span._reference) : ref Unsafe.AsRef<T>((void*)1);
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static unsafe ref T GetNonNullPinnableReference<T>(ReadOnlySizableSpan<T> span) => ref (span.Length != 0) ? ref Unsafe.AsRef(in span._reference) : ref Unsafe.AsRef<T>((void*)1);
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe SizableSpan<TTo> Cast<TFrom, TTo>(SizableSpan<TFrom> span)
            where TFrom : struct
            where TTo : struct {
        ...
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe ReadOnlySizableSpan<TTo> Cast<TFrom, TTo>(ReadOnlySizableSpan<TFrom> span)
            where TFrom : struct
            where TTo : struct {
            if (RuntimeHelpers.IsReferenceOrContainsReferences<TFrom>())
                ThrowHelper.ThrowInvalidTypeWithPointersNotSupported(typeof(TFrom));
            ...
            return new ReadOnlySizableSpan<TTo>(
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SizableSpan<T> CreateSizableSpan<T>(scoped ref T reference, int length) =>
            new SizableSpan<T>(ref Unsafe.AsRef(in reference), length);
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ReadOnlySizableSpan<T> CreateReadOnlySizableSpan<T>(scoped ref readonly T reference, int length) =>
            new ReadOnlySizableSpan<T>(ref Unsafe.AsRef(in reference), length);
        ...
        public static unsafe ReadOnlySizableSpan<char> CreateReadOnlySizableSpanFromNullTerminated(char* value) =>
            value != null ? new ReadOnlySizableSpan<char>(value, string.wcslen(value)) :
            default;
        ...
        public static unsafe ReadOnlySizableSpan<byte> CreateReadOnlySizableSpanFromNullTerminated(byte* value) =>
            value != null ? new ReadOnlySizableSpan<byte>(value, string.strlen(value)) :
            default;
...
#pragma warning restore 8762
        ...
        public static IEnumerable<T> ToEnumerable<T>(ReadOnlyMemory<T> memory) {
            ...
            // use the general one for any ReadOnlyMemory, that will incur a .SizableSpan access for every element.
            ...
            // The ROM<T> wraps a MemoryManager<T>. The best we can do is iterate, accessing .SizableSpan on each MoveNext.
            return FromMemoryManager(memory);

            static IEnumerable<T> FromMemoryManager(ReadOnlyMemory<T> memory) {
                for (int i = 0; i < memory.Length; i++) {
                    yield return memory.SizableSpan[i];
                }
            }
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe T Read<T>(ReadOnlySizableSpan<byte> source)
            where T : struct {
            if (RuntimeHelpers.IsReferenceOrContainsReferences<T>()) {
                ThrowHelper.ThrowInvalidTypeWithPointersNotSupported(typeof(T));
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe bool TryRead<T>(ReadOnlySizableSpan<byte> source, out T value)
            where T : struct {
            if (RuntimeHelpers.IsReferenceOrContainsReferences<T>()) {
                ThrowHelper.ThrowInvalidTypeWithPointersNotSupported(typeof(T));
            }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe void Write<T>(SizableSpan<byte> destination, in T value)
            where T : struct {
            if (RuntimeHelpers.IsReferenceOrContainsReferences<T>()) {
                ThrowHelper.ThrowInvalidTypeWithPointersNotSupported(typeof(T));
            }
        ...
        /// <returns>If the span is too small to contain the type T, return false.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe bool TryWrite<T>(SizableSpan<byte> destination, in T value)
            where T : struct {
            if (RuntimeHelpers.IsReferenceOrContainsReferences<T>()) {
                ThrowHelper.ThrowInvalidTypeWithPointersNotSupported(typeof(T));
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe ref T AsRef<T>(SizableSpan<byte> span)
            where T : struct {
            if (RuntimeHelpers.IsReferenceOrContainsReferences<T>()) {
                ThrowHelper.ThrowInvalidTypeWithPointersNotSupported(typeof(T));
            }
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe ref readonly T AsRef<T>(ReadOnlySizableSpan<byte> span)
            where T : struct {
            if (RuntimeHelpers.IsReferenceOrContainsReferences<T>()) {
                ThrowHelper.ThrowInvalidTypeWithPointersNotSupported(typeof(T));
            }
