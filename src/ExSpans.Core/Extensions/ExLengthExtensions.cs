...
namespace Zyl.SizableSpans.Extensions {
    /// <summary>
    /// Extensions of SizabledLength methods (SizabledLength 方法的扩展)
    /// </summary>
    public static class SizabledLengthExtensions {
        ...
        public static TSize SizabledLength<T>(this T[] source) {
        ...
        [MyCLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TSize SizabledLength<T>(this ArraySegment<T> source) {
        ...
        [MyCLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TSize SizabledLength<T>(this ReadOnlySpan<T> source) {
            return (TSize)source.Length;
        }
        ...
        [MyCLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TSize SizabledLength<T>(this Span<T> source) {
            return (TSize)source.Length;
        }
        ...
        [MyCLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TSize SizabledLength<T>(this string source) {
            return (TSize)source.Length;
        }
