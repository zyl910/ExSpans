...
namespace Zyl.ExSpans {
    ...
    /// </code>
    /// </example>
    /// <para><see cref="SafeBufferSpanProvider"/> is a lightweight, low overhead approach. Although PointerExMemoryManager has a higher overhead, but it supports <see cref="Memory{T}"/> types (SafeBufferSpanProvider是一种轻量级低开销的办法. 而 PointerExMemoryManager 虽然开销大一些, 但它支持 Memory 类型).</para>
    /// </remarks>
