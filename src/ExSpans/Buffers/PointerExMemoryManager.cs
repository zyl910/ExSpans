...
namespace Zyl.ExSpans.Buffers {
    ...
    /// </remarks>
    public sealed class PointerExMemoryManager<T> : AbstractPointerExMemoryManager<T, IDisposable>, IDisposable where T : unmanaged {
...
#pragma warning restore CA2015
        ...
        [CLSCompliant(false)]
        public unsafe PointerExMemoryManager(IDisposable? owner, void* pointer, TSize length, bool needFree) : base(owner, pointer, length, needFree) {
        }
        ...
        /// <exception cref="ArgumentOutOfRangeException">The length parameter must be greater than or equal to 0.</exception>
        [CLSCompliant(false)]
        public unsafe PointerExMemoryManager(IDisposable? owner, void* pointer, TSize length) : this(owner, pointer, length, true) {
        }
        ...
        /// <exception cref="ArgumentOutOfRangeException">The length parameter must be greater than or equal to 0.</exception>
        [CLSCompliant(false)]
        public unsafe PointerExMemoryManager(void* pointer, TSize length, bool needFree) : this(null, pointer, length, needFree) {
        }
        ...
        /// <exception cref="ArgumentOutOfRangeException">The length parameter must be greater than or equal to 0.</exception>
        [CLSCompliant(false)]
        public unsafe PointerExMemoryManager(void* pointer, TSize length) : this(null, pointer, length, true) {
        }
