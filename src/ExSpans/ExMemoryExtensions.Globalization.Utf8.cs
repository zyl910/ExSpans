...
namespace Zyl.ExSpans {
    partial class ExMemoryExtensions {
        ...
        internal static bool EqualsOrdinalIgnoreCaseUtf8(this ReadOnlyExSpan<byte> span, ReadOnlyExSpan<byte> value) {
        ...
        internal static bool StartsWithUtf8(this ReadOnlyExSpan<byte> span, ReadOnlyExSpan<byte> value, StringComparison comparisonType) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static bool StartsWithOrdinalIgnoreCaseUtf8(this ReadOnlyExSpan<byte> span, ReadOnlyExSpan<byte> value) {
            // For UTF-8 ist is possible for two spans of different byte length
            // to compare as equal under an OrdinalIgnoreCase comparison.
